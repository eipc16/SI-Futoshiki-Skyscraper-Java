...
public class PuzzleVariable extends Variable<Integer> implements Comparable<PuzzleVariable> {
    ...
    public PuzzleVariable(Integer value, int column_position, int row_position, Domain domain, boolean predefined) {
        super(value, domain, predefined);
        this.row_position = row_position;
        this.column_position = column_position;
    }

    public PuzzleVariable(Integer value, int column_position, int row_position, Domain domain) {
