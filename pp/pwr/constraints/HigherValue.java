...
public class HigherValue<T extends Comparable<T>> implements ConstraintInterface<T> {

    private Variable<T> parentVariable;
    private Variable<T> constrainedVariable;
    T defaultValue;

    public HigherValue(Variable<T> parentVariable, Variable<T> constrainedVariable, T defaultValue) {
